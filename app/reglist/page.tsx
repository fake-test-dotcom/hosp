  ...
  return (
      ...
      <NavLinks>
        ...
        <Link href="/services" passHref>
          ...
          <Link href="/register" passHref>
            <StyledLink>
              <FaEdit style={{ fontSize: '20px', marginRight: '2px' }} />Register
            </StyledLink>
          </Link>  
        <li style={{color:'green'}}>
         
              <FaEye style={{ fontSize: '20px', marginRight: '2px',color: 'green' }} />View Tables
    ...
    <div style={styles.mainContainer}>
      ...
      <div style={styles.overlay}>
        <h1 style={styles.heading}>Welcome to Table view page of Apollo Hospital</h1>
