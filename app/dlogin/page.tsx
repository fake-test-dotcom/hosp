...
export default function Login2() {
  ...
  const styles: { [key: string]: CSSProperties } = {
    mainContainer: {
      ...
      width: '100%',
      height: '100vh',
      backgroundImage: 'url("/images/funnydoc 12212.png")',
  ...
  return (
    <div style={styles.mainContainer}>
      ...
      <div style={styles.overlay}>
        <h1 style={styles.heading}>Login as a Doctor</h1>
        <div style={styles.formContainer}>
          ...
          <div style={styles.signupText}>
            <Link href="/login1" style={styles.signupLink}>Continue as a patient</Link>
          </div>
          <br />
          <br />
